...
def is_cdr_date(date,target_unit):
    ...
    if (target_unit == "main" and (weekday == 0 or weekday == 1 or weekday == 2 or weekday == 3 or weekday == 4 or weekday == 5 or weekday == 6) and (hour >= 6 and hour <= 22)):
        return True
...
CDR_FOLDER = str(Path(__file__).parent) + '\\cdr_data\\'    # Windows - needs this because of os.listdir
...
# HOURLY_REPORT_CSV_FILE = '/home/pbx/cucm-cdr-analyzer/data/hourly_report.csv'
        ...
        try:
            ...
            if (len(list[8]) == 12 and "\"1001\"" in list[29]):
                ...
                if is_cdr_date(date,"main"):
                    ...
                    if (("1001" in list[30] or "5701" in list[30] or "5702" in list[30] or "5703" in list[30] or "5704" in list[30] or "5705" in list[30]) and list[55] is not "0"):
            ...
            ################
            # Lyndsey Clinic
            if (len(list[8]) >= 12 and ("\"5850\"" in list[29] or "8307742505" in list[29] or "8307757555" in list[29] or "8303137138" in list[29])):
                key = 'lyndsey'
                if (is_cdr_date(date,"lyndsey")):
                    ...
                    total_calls_hourly[key] += 1
                    total_calls_list_hourly[key][hour] += 1
                    if (("5850" in list[30] or "8307742505" in list[30] or "8307757555" in list[30] or "8303137138" in list[30]) and list[55] is not "0"):
                        answered_calls[key] += 1
                        answered_calls_list[key][day] += 1
